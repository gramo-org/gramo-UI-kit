...
$(document).ready(function() {
  ...
  // Toggle menu's sidebar dropdown
  $('.sidebar-profile__link.toggle-dropdown').click(function(e) {
    e.preventDefault()
    $('.toggle-dropdown').toggleClass('toggle-dropdown--open')
    $('.profile-dropdown').toggleClass('profile-dropdown--expanded')
  })
  ...
  $('.searchable-list__heading').on('click', function() {
    $(this)
      .parent()
      .toggleClass('searchable-list--open')
  })
  ...
  $('.fake-table__toggle-row').click(function() {
    $(this)
      .closest('.fake-table__row')
      .toggleClass('fake-table__row--expanded')
      .siblings()
      .removeClass('fake-table__row--expanded')
  ...
  $('.table__head--expandable').click(function() {
    $(this)
      .toggleClass('table__head--expanded')
      .siblings()
      .removeClass('table__head--expanded')
  })
  ...
  $('.vertical__nav__item--has-children > a').click(function(e) {
    ...
    $(this)
      .parent()
      .toggleClass('vertical__nav__item--is-expanded')
  })
  ...
  $('tr.drilldown-body[data-level=2]').click(function() {
    $(this)
      .addClass('table__row--selected')
      .siblings()
      .removeClass('table__row--selected')
  })
  ...
  $('.form__input--toggle-visibility').click(function() {
    if ($(this).is(':checked')) {
      ...
      $(this)
        .parent()
        .removeClass('form__label--toggled')
    }
  })
  ...
  $('.statusboard__close').click(function() {
    $(this)
      .parent()
      .toggleClass('statusboard--minimise')
  })
  ...
  $('.form__input--searchable').bind('blur', function() {
    $(this)
      .next('.searchable-list')
      .removeClass('searchable-list--open')
  })
  $('.form__input--searchable').bind('focus', function() {
    $(this)
      .next('.searchable-list')
      .addClass('searchable-list--open')
  })
  ...
  $('.link--edit').click(function() {
    ...
    if (document.location.href.indexOf('minside') > -1) {
      ...
      $(this)
        .closest('section')
        .find('.form')
        .find('.searchable-list')
        .not('.locked')
        .toggleClass('searchable-list--disabled')
      $(this).toggleClass('link--edit--hidden btn btn--secondary')
      $(this)
        .closest('section')
        .find('.link--trash')
        .toggleClass('link--trash--hidden')
      $(this)
        .closest('section')
        .find('.btn--add, .link--add')
        .toggleClass('link--add--hidden')
      $(this)
        .closest('section')
        .find('.text--help')
        .toggleClass('text--help--hidden')
      $(this)
        .closest('section')
        .find('.link-prototype')
        .toggleClass('link-prototype--hidden')

      if ($(this).hasClass('link--edit--hidden')) {
        $(this).text('Avbryt')
        $(this)
          .parent()
          .append('<button class="btn btn--primary">Lagre</button>')
      } else {
        $(this)
          .parent()
          .find('.btn--primary')
